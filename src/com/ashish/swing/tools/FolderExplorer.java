...
package com.ashish.swing.tools;
...
class FolderExplorer extends JPanel implements ActionListener {
	...
	private static final long serialVersionUID = -3669423790141717112L;
	JTextField jtf;
	JTextArea jta;
	JTree tree;
	JButton refresh;
	...
	final String[] colHeads = { "File Name", "SIZE(in Bytes)", "Read Only",
			"Hidden" };
	String[][] data = { { "", "", "", "", "" } };
...
/***********************************/
class FolderExplorerTest extends JFrame {

	private static final long serialVersionUID = -7139243428719063865L;

	FolderExplorerTest(String path) {
